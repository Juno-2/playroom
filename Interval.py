...
sixHour = Client.KLINE_INTERVAL_6HOUR
eightHour = Client.KLINE_INTERVAL_8HOUR
twelveHour = Client.KLINE_INTERVAL_12HOUR
oneDay = Client.KLINE_INTERVAL_1DAY
threeDay = Client.KLINE_INTERVAL_3DAY
oneWeek = Client.KLINE_INTERVAL_1WEEK
oneMonth = Client.KLINE_INTERVAL_1MONTH
